<div class="relative h-[50vh] min-h-[800px] w-full max-w-[1200px] mx-auto py-[100px]">
    ...
    <div class="flex justify-between items-center gap-[20px]">
        <div class="relative flex flex-col w-1/2 gap-10">
            ...
            <p class="text-lg">
                I am a Front End Developer. I craft engaging and intuitive interfaces with user-centric web applications.
            </p>
            <div class="absolute top-0 right-0 z-10 -translate-y-1/2">
                <img src='/pattern/three-l-2.svg' class="w-[100px] rotate-45">
            </div>
...
<style>
    ...
    .underline-tech::after {
      content: '';
      position: absolute;
      left: 0;
      bottom: -5px; /* Adjust as needed */
      width: 100%;
      height: 20px; /* Thickness of the underline */
      background-color: rgba(235, 184, 132, 0.4); /* #EBB884 with 50% opacity */
      z-index: -1;
    }
  </style>
